...
const ConferenceBrowser = () => {
  ...
  const [eventStatus, setEventStatus] = useState<'all' | 'upcoming' | 'completed'>('all')
  ...
  const conferences = [
    {
      title: "International Conference on Multidisciplinary Breakthroughs and NextGen Technologies (ICMBNT–2024)",
      publisher: "Society for Cyber Intelligent Systems",
      year: 2024,
      hasHistory: false,
      description:
        "Hybrid Conference (In-person + Virtual) exploring cutting-edge innovations across multiple disciplines. Join experts from around the world to discuss and collaborate on next-generation technologies that are shaping our future.",
      ...
      fullDescription: `
        <h2>International Conference on Multidisciplinary Breakthroughs and NextGen Technologies (ICMBNT–2024)</h2>
        <p><strong>Date:</strong> April 26 & 27, 2024</p>
        ...
        <p>ICMBNT-2024 brings together researchers, industry professionals, and academic experts to explore cutting-edge innovations across multiple disciplines. The conference aims to foster collaboration and knowledge exchange on next-generation technologies that are shaping our future.</p>
        <br>
        <h3>Key Topics</h3>
        <ul>
        ...
        <p><strong>Paper Submission Deadline:</strong> March 25, 2024</p>
        <p><strong>Notification of Acceptance:</strong> April 5, 2024</p>
        <p><strong>Registration Deadline:</strong> April 12, 2024</p>
        <p><strong>Conference Dates:</strong> April 26, 27, 2024</p>
      `,
    },
    {
      title: "International Conference on Multidisciplinary Breakthroughs and NextGen Technologies (ICMBNT–2026)",
      publisher: "Society for Cyber Intelligent Systems",
      year: 2026,
      hasHistory: false,
      description:
      ...
      registrationUrl: "https://societycisicmbnt2026.vercel.app/",
      featured: true,
      status: "upcoming" as const,
      fullDescription: `
        <h2>International Conference on Multidisciplinary Breakthroughs and NextGen Technologies (ICMBNT–2026)</h2>
        <p><strong>Date:</strong> March 15 & 16, 2026</p>
        <p><strong>Venue:</strong> SRM HOTEL - Maraimalai Nagar - CHENNAI - India</p>
        <p><strong>Format:</strong> Hybrid Conference (In-person + Virtual)</p>
        <p><strong>Organized by:</strong> Society for Cyber Intelligent Systems, Puducherry – India</p>
        <br>
        <h3>About The Conference</h3>
        <p>ICMBNT-2026 brings together researchers, industry professionals, and academic experts to explore cutting-edge innovations across multiple disciplines. The conference aims to foster collaboration and knowledge exchange on next-generation technologies that are shaping our future.</p>
        <br>
        <h3>Key Topics</h3>
        <ul>
          <li>Artificial Intelligence and Machine Learning</li>
        ...
        <br>
        <h3>Important Dates</h3>
        <p><strong>Paper Submission Deadline:</strong> February 15, 2026</p>
        <p><strong>Notification of Acceptance:</strong> February 25, 2026</p>
        <p><strong>Registration Deadline:</strong> March 5, 2026</p>
        <p><strong>Conference Dates:</strong> March 15-16, 2026</p>
      `,
    }
  ]
  ...
  const filteredConferences = useMemo(() => {
    return conferences.filter((conference: Conference) => {
      ...
      const matchesStatus = eventStatus === 'all' || conference.status === eventStatus
      return matchesSearch && matchesYear && matchesPublisher && matchesStatus
    })
  }, [searchQuery, yearFilterType, yearRange, singleYear, selectedPublishers, eventStatus])
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-r from-red-600 to-red-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-lg opacity-90">Explore global cybersecurity conferences, summits, and symposiums</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-12 gap-6">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-red-900 to-transparent">
                  <h3 className="font-bold text-white text-xl">Completed Events</h3>
                  <p className="text-white">View completed ICMBNT2024 conference</p>
                </div>
              </div>

              <div className="p-4 bg-gradient-to-r from-red-50 to-white">
                <h4 className="font-semibold text-red-800 mb-2">ICMBNT–2024</h4>
          ...
          <div className="col-span-6">
            <div className="mb-8 bg-white p-4 rounded-lg shadow-sm">
              <div className="flex gap-4 mb-4">
                <button 
                  ...
                  className={`font-medium pb-1 ${eventStatus === 'all' ? 'text-red-500 border-b-2 border-red-500' : 'text-gray-600 hover:text-red-500'}`}
                >
                  All Events
                </button>
                <button 
                  onClick={() => setEventStatus('upcoming')}
                  className={`font-medium pb-1 ${eventStatus === 'upcoming' ? 'text-red-500 border-b-2 border-red-500' : 'text-gray-600 hover:text-red-500'}`}
                >
                  Upcoming Events
                </button>
                <button 
                  onClick={() => setEventStatus('completed')}
                  className={`font-medium pb-1 ${eventStatus === 'completed' ? 'text-red-500 border-b-2 border-red-500' : 'text-gray-600 hover:text-red-500'}`}
                >
                  Past Events
                </button>
              </div>
            ...
            <div className="space-y-4">
              {filteredConferences.map((conference: Conference, index: number) => (
                <div
                  key={index}
          ...
          <div className="col-span-3 space-y-6 bg-white p-4 rounded-lg shadow-sm">
            <div className="border-b pb-4">
              ...
              >
                <span>Year</span>
                {expandedSections.year ? <ChevronDown className="w-4 h-4" /> : <ChevronRight className="w-4 h-4" />}
              </button>
              {expandedSections.year && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={clearYearFilter} className="text-sm text-red-500 hover:text-red-600">
                      Clear
                    </button>
                  </div>
                  ...
                  {yearFilterType === "range" ? (
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleYearRangeChange("start", Number.parseInt(e.target.value))}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full p-1 border border-gray-300 rounded text-sm"
                          value={yearRange.end}
                          onChange={(e) => handleYearRangeChange("end", Number.parseInt(e.target.value))}
                        />
                      </div>
                    </div>
                  ) : (
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-1 border border-gray-300 rounded text-sm"
                        value={singleYear}
                        onChange={(e) => setSingleYear(Number.parseInt(e.target.value))}
                      />
                    </div>
                  )}
                </div>
            ...
            <div className="border-b pb-4">
              ...
              >
                <span>Topic</span>
                {expandedSections.topic ? <ChevronDown className="w-4 h-4" /> : <ChevronRight className="w-4 h-4" />}
              </button>
              ...
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-lg shadow-md p-6 border-l-4 border-red-500">
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-1/3">
                    <img
                      src={selectedConference.image || "/placeholder.svg"}
                  ...
                  <div className="md:w-2/3">
                    <div className="flex items-center mb-3">
                      ...
                      <span className="text-red-700 font-medium text-sm">{selectedConference.publisher}</span>
                    </div>
                    <h2 className="text-xl font-bold text-gray-900 mb-2">{selectedConference.title}</h2>
                    ...
                    <p className="text-gray-600 mb-4">{selectedConference.description}</p>
